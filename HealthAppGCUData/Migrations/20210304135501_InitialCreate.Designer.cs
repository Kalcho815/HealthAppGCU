...
namespace HealthAppGCUData.Migrations
{
    ...
    [Migration("20210304135501_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HealthAppGCUData.Models.ActivitiesDailyReports", b =>
                {
                    b.Property<string>("HealthcareActivityId")
                        .HasColumnType("varchar(256)");
                    ...
                    b.HasKey("HealthcareActivityId", "DailyReportId");

                    b.HasIndex("DailyReportId");

                    b.ToTable("ACTIVITIES_DAILY_REPORTS");
                });
            ...
            modelBuilder.Entity("HealthAppGCUData.Models.ActivitiesDailyReports", b =>
                {
                    b.HasOne("HealthAppGCU.Models.DailyReport", "DailyReport")
                        .WithMany()
